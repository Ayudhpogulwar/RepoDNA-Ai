...
export const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { name: 'Build Pipeline', path: 'pipeline', icon: Activity, color: 'text-violet-400', bg: 'hover:bg-violet-500/5 hover:text-violet-300', activeClass: 'from-violet-600 to-purple-600 shadow-violet-500/20' },
